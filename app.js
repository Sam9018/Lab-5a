...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  multiplyTwo = multiply(multiplyTwo, c)[0];

  return [sum2, multiplyTwo, a + ' and ' + b + ' and ' + c + ' sum to ' + sum2 + '.', 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multiplyTwo];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  for(var i = 0; i < multArr.length; i++){
    multiply3 = multiply(multiply3, multArr[i])[0];
  }
  return[multiply3, 'The numbers '+ multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of 24.'];
}
